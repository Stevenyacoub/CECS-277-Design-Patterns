...
public class DataSetReader{
    ...
    */
    private void readData(Scanner in) throws BadDataException, InputMismatchException, NoSuchElementException {
    ...
    */
    private void readValue(Scanner in, int i) throws InputMismatchException, NoSuchElementException{
        data[i] = in.nextDouble(); //Read a double value and store it in the array data
    }
}